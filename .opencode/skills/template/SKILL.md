...
Verificar que el skill `invitation-context` se ha ejecutado y el usuario ha proporcionado toda la información requerida (nombre, slug, contenido, fecha, ubicación, etc.). Si no: ejecutar `.opencode/skills/invitation-context/SKILL.md`, formular las preguntas pendientes y **DETENER**. No continuar al paso 1 hasta tener contexto completo. NUNCA suponer valores.
