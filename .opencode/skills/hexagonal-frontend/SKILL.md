...
description: Execute frontend tasks under strict hexagonal architecture (domain/application/adapters/ui/app) without breaking Atomic Design or responsive behavior.
...
### 1) Verificar branch
- Si estás en `main` o `develop`, detener y crear rama feature primero.
...
- Si hay dudas de cumplimiento, auditar con `hexagonal-guardian`.
