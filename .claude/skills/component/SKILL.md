...
argument-hint: "<atom|molecule|organism> <ComponentName> [description]"
---

Create or modify a component following Atomic Design and project conventions.

**Input:** $ARGUMENTS
Parse: `$1` = level (atom/molecule/organism), `$2` = ComponentName (PascalCase), rest = description.
